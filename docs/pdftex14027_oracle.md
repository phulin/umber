...
`tests/pdftex14027-oracle/instrumentation.ch` as the final change. That change
ports the complete shared TeX82/e-TeX schema-v1 command trace through stable
pdfTeX seams without editing canonical or generated upstream engine files.
The detached trace is written to `pdftex14027-events.jsonl`.
