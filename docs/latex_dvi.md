...
| `\ifincsname`   | done   | Tests whether expansion is currently constructing a control-sequence name, using the canonical pdfTeX conditional without exposing pdfTeX engine identity in LaTeX-DVI mode.                                                            |
