...
| raw preamble collection                      | retain raw delivery through `#`, `&`, and the terminating `\cr`; freeze u/v pairs before restoring scanner status                                                                                          | `tex_command::CommandProcessor::begin_alignment_preamble_scan`                                                        |
