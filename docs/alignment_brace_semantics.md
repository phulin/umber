...
| preamble opening brace                       | validate it through expanded command input, then back it up before preamble delivery                                   | `CommandProcessor::scan_alignment_preamble_opening`                                                        |
