...
| preamble opening brace                       | validate it through expanded command input, then replay it through the successive backup/start lifecycle before preamble delivery | `CommandProcessor::{scan_alignment_preamble_opening,replay_alignment_preamble_opening}`                    |
