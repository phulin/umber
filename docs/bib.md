...
The foundation, input, graph, names, sorting, labels, and uniqueness
translation cohorts contribute 1,225 isolated Rust xfails across 43
...
expected expressions. This keeps assertion order, fixture references,
expected bytes, normalization forms, and Unicode directly auditable while the
