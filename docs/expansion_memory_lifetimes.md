...
and expression stacks remain live engine state; they are not parked resource
state.
...
| Detached resource recipe                                                                              | Handle-free validated resource metadata used by a later fresh operation                                                                                                                                                | Contains no runtime generation and cannot encode a nested command or scanner continuation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | DTO drop                                                                                                                                                                                      | N/A / yes, because it contains no live engine state                                                    | Cold copying and heap allocation are allowed only for bounded host/resource DTOs; materialization builds fresh destination-local values atomically                                                                                                                                                                                                                                                                                                                                       |
...
resource suspension unwinds the invocation and is represented only by the
...
command-side resume owner. Preparation writes
...
enum. Initial raw delivery and expanded delivery write
...
scanning borrow and mutate that frame in place; a resource error unwinds this
frame and host replay reconstructs it from the checkpoint. Its
...
Handle-free resource recipes are host-owned cold values. They contain no live
command, scanner, input, or generation coordinate; replay materializes fresh
