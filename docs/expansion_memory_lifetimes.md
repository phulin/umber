...
state/command/mode runtime and the returned command-timeline loan before insertion, and
...
bounded command frame while generation-owned append rows remain behind logical
tops for the retained prefix; definition and token-list payloads follow their
