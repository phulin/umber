...
The detached 173-line capture catalogue and 467-line duplicate census were deleted. Manifest data fell from 10,448 to 7,258 lines (3,190 lines removed); authored Rust/shell changed by +291/-832 lines (net -541), while the corpus/schema/catalogue changed by +7,277/-10,396 lines (net -3,119).
