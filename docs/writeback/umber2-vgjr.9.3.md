...
Authority: [`tex-command`'s integrated primitive catalogue](../../crates/tex-command/src/primitives), completed by implementation commit `9ee00dd5a`.
...
The retired predecessors are `tex-exec`'s TeX82/e-TeX parameter, page, special,
...
Implementation commit `9ee00dd5a` has 488 additions and 1,029 deletions in
authored Rust: 541 lines of measured net deletion. Documentation and guidance
