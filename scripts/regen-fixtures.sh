...
Fixture areas:
  ...
  end-to-end:  e2e  (story, gentle, and trip fixed DVI fixtures)
...
Reference tools:
  ...
  End-to-end regeneration requires the fetched external inputs. Story and
  Gentle use parity-harness to stage live reference TeX consistently; TRIP
