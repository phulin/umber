...
The `raw-tex82-loaded` allowlist contains exactly 172 jobs: the reviewed
35-case scanner/input/conditional cohort, 55 ordinary main-control cases, and
all 18 alignment, 34 math, and 30 page-output cases.
...
the live e-TeX-capable reference executable. Small `<case>.txt` case-local inputs
