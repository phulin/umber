% Final transparent base command-core instrumentation for canonical e-TeX 2.6.
...
@x [18] Observe committed local equivalent writes at the e-TeX seam.
...
@x [18] Observe committed local fullword writes at the e-TeX seam.
eqtb[p].int:=w;
assign_trace(p,"into")@;@/
exit:end;
@y
...
@x [23] Observe source pushes after e-TeX/Web2C source initialization.
...
@x [23] Observe e-TeX pseudo-file and ordinary source retirement.
