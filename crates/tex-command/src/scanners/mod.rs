...
pub use structured::{
    ...
    MathScriptKind, MathStyleKind, MathTextFieldKind, PdfColorStackActionRequest,
    PdfDocumentFragmentRequest, PdfFormRequest, PdfGraphicsRequest, PdfImagePageBox,
    PdfImageRequest, PdfObjectRequest, PdfReferenceObjectRequest, RegisteredInput, ScannedAccent,
