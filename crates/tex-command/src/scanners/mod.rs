...
pub use structured::{
    AlignmentCellOpening, FileNameTermination, ImmediateExtension, RegisteredInput,
    ScannedBalancedText, ScannedBoxRegister, ScannedFileName, ScannedGlueParameterAssignment,
