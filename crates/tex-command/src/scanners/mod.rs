...
pub use structured::{
    ...
    FileNameTermination, FontLoadRequest, FontSizeRecovery, GeneratedFontKind, ImmediateExtension,
    ...
    ScannedGeneratedFontDefinition, ScannedGlueParameterAssignment, ScannedInsertConstruction,
    ...
    ScannedSetBoxAssignment, ScannedSetBoxPath, ScannedVSplit, StructuredProvenance,
    WriteStreamSelector,
};
