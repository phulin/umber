...
pub use structured::{
    AlignmentCellOpening, FileNameTermination, ImmediateExtension, RegisteredInput, ScannedAccent,
    ScannedAccentBase, ScannedBalancedText, ScannedBoxRegister, ScannedDiscretionary,
