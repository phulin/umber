...
- `src/format_worker.rs`: stable-executable, per-child authenticated recipe/result protocol and killable native wall/RSS-supervised format-construction process.
