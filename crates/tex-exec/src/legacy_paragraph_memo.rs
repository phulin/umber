...
pub(crate) fn try_reuse_aligned_paragraph(
    ...
    crate::canonical_paragraph_memo::replay_mutations(stores, &entry.mutations);
...
fn validate_paragraph_entry(
    ...
    let mutation_entry_class_changed = !crate::canonical_paragraph_memo::same_mutation_entry_class(
...
fn validate_mutations(stores: &Universe, mutations: &[tex_state::PureParagraphMutation]) -> bool {
    crate::canonical_paragraph_memo::validate_mutations(stores, mutations)
}
...
fn paragraph_input_provenance(
    ...
    let mut recipe = crate::canonical_paragraph_memo::ParagraphProvenanceBuilder::default();
