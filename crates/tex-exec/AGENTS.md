...
- `src/paragraph_memo.rs`: bounded paragraph trace preflight, full prior-generation region validation, dependency-tiered retained hlist/finished-line import, ordered count/integer-parameter redo, provenance rebinding, barrier classification, and telemetry.
