...
- `src/math/`: pure Appendix G math-list conversion helpers, style transitions, math parameter snapshots, script placement, and inter-noad spacing over owned hlist output.
