...
fn assertion_001_parsename_x_1() {
    pass_upstream(
        ...
        r####"$name1"####,
        r####"is_deeply(tparsename_x($section,'given=John,family=Doe', 'author'), $name1, 'parsename_x 1');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_002_parsename_x_2() {
    pass_upstream(
        ...
        r####"$name2"####,
        r####"is_deeply(tparsename_x($section,'family=Doe, suffix=Jr, given=John, given-i=J', 'author'), $name2, 'parsename_x 2');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_003_parsename_x_3() {
    pass_upstream(
        ...
        r####"$name3"####,
        r####"is_deeply(tparsename_x($section,'prefix=von, family=Berlichingen zu Hornberg, given=Johann Gottfried', 'author'), $name3, 'parsename_x 3') ;"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_004_parsename_x_4() {
    pass_upstream(
        ...
        r####"tparsename_x($section,'prefix=von, family=Berlichingen zu Hornberg, given=Johann Gottfried', 'author')"####,
        r####"$name4"####,
        r####"is_deeply(tparsename_x($section,'prefix=von, family=Berlichingen zu Hornberg, given=Johann Gottfried', 'author'), $name4, 'parsename_x 4') ;"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_005_parsename_x_5() {
    pass_upstream(
        ...
        r####"$name5"####,
        r####"is_deeply(tparsename_x($section,'"family={Robert and Sons, Inc.}"', 'author'), $name5, 'parsename_x 5') ;"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_006_parsename_x_6() {
    pass_upstream(
        ...
        r####"$name6"####,
        r####"is_deeply(tparsename_x($section,'family=al-Ṣāliḥ, given=ʿAbdallāh', 'author'), $name6, 'parsename_x 6') ;"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_007_parsename_x_7() {
    pass_upstream(
        ...
        r####"$name7"####,
        r####"is_deeply(tparsename_x($section,'given=Jean Charles Gabriel, prefix=de la, family=Vallée Poussin', 'author'), $name7, 'parsename_x 7');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_008_parsename_x_8() {
    pass_upstream(
        ...
        r####"tparsename_x($section,'given={Jean Charles Gabriel}, prefix=de la, family=Vallée Poussin', 'author')"####,
        r####"$name8"####,
        r####"is_deeply(tparsename_x($section,'given={Jean Charles Gabriel}, prefix=de la, family=Vallée Poussin', 'author'), $name8, 'parsename_x 8');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_009_parsename_x_9() {
    pass_upstream(
        ...
        r####"$name9"####,
        r####"is_deeply(tparsename_x($section,'given=Jean Charles Gabriel de la Vallée, given-i=JCGdV, family=Poussin', 'author'), $name9, 'parsename_x 9');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_010_parsename_x_10() {
    pass_upstream(
        ...
        r####"tparsename_x($section,'given=Jean Charles Gabriel, prefix=de la, family={Vallée Poussin}', 'author')"####,
        r####"$name10"####,
        r####"is_deeply(tparsename_x($section,'given=Jean Charles Gabriel, prefix=de la, family={Vallée Poussin}', 'author'), $name10, 'parsename_x 10');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_011_parsename_x_11() {
    pass_upstream(
        ...
        r####"tparsename_x($section,'given={Jean Charles Gabriel}, prefix=de la, family={Vallée Poussin}', 'author')"####,
        r####"$name11"####,
        r####"is_deeply(tparsename_x($section,'given={Jean Charles Gabriel}, prefix=de la, family={Vallée Poussin}', 'author'), $name11, 'parsename_x 11');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_012_parsename_x_12() {
    pass_upstream(
        ...
        r####"$name12"####,
        r####"is_deeply(tparsename_x($section,'given=Jean Charles Gabriel, family=Poussin', 'author'), $name12, 'parsename_x 12');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_013_parsename_x_13() {
    pass_upstream(
        ...
        r####"$name13"####,
        r####"is_deeply(tparsename_x($section,'given=Jean Charles, family={Poussin Lecoq}', 'author'), $name13, 'parsename_x 13');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_014_parsename_x_14() {
    pass_upstream(
        ...
        r####"$name14"####,
        r####"is_deeply(tparsename_x($section,'given=J. C. G., prefix=de la, family=Vallée Poussin', 'author'), $name14, 'parsename_x 14');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_015_parsename_x_15() {
    pass_upstream(
        ...
        r####"$name15"####,
        r####"is_deeply(tparsename_x($section,'given=E. S., family=El-Mallah', 'author'), $name15, 'parsename_x 15');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_016_parsename_x_16() {
    pass_upstream(
        ...
        r####"$name16"####,
        r####"is_deeply(tparsename_x($section,'given=E. S., family=Kent-Boswell', 'author'), $name16, 'parsename_x 16');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_017_parsename_x_17() {
    pass_upstream(
        ...
        r####"$name17"####,
        r####"is_deeply(tparsename_x($section,'family=Other, given=A.~N.', 'author'), $name17, 'parsename_x 17');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_018_parsename_x_18() {
    pass_upstream(
        ...
        r####"$name18"####,
        r####"is_deeply(tparsename_x($section,'family={British National Corpus}', 'author'), $name18, 'parsename_x 18');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_019_parsename_x_19() {
    pass_upstream(
        ...
        r####"$name19"####,
        r####"is_deeply(tparsename_x($section,'sortingnamekeytemplatename=test, family=Smith, given=Bill', 'author'), $name19, 'parsename_x 19');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_020_parsename_x_19a() {
    pass_upstream(
        ...
        r####"$name19snks"####,
        r####"eq_or_diff(Biber::Input::file::bibtex::parsename_x($section, 'sortingnamekeytemplatename=test, family=Smith, given=Bill', 'author')->{sortingnamekeytemplatename}, $name19snks, 'parsename_x 19a');"####,
        UPSTREAM_SOURCE,
    );
}
...
fn assertion_021_parsename_x_20() {
    pass_upstream(
        ...
        r####"$name20"####,
        r####"is_deeply(tparsename_x($section,'family=Doe, family-i={Do}', 'author'), $name20, 'parsename_x 20');"####,
        UPSTREAM_SOURCE,
    );
}
