...
fn assertion_001_list_name_order() {
    pass_upstream(
        ...
        r####"['K11', 'K1', 'K2', 'K4', 'K3', 'K7', 'K8', 'K9', 'K10', 'K12', 'K5', 'K6']"####,
        r####"is_deeply($biber->datalists->get_lists_by_attrs(section           => 0,
                                       name                       => 'lname',
                                       type                       => 'entry',
                                       sortingtemplatename        => 'lname',
                                       sortingnamekeytemplatename => 'global',
...
fn assertion_002_list_year_order() {
    pass_upstream(
        ...
        r####"$biber->datalists->get_lists_by_attrs(section           => 0,
                                       ...
                                       uniquenametemplatename     => 'global',
                                       labelalphanametemplatename => 'global')->[0]->get_keys"####,
        r####"['K8', 'K9', 'K10', 'K4', 'K1', 'K11', 'K12', 'K2', 'K3', 'K6', 'K5', 'K7']"####,
        r####"is_deeply($biber->datalists->get_lists_by_attrs(section           => 0,
                                       name                       => 'lyear',
                                       type                       => 'entry',
                                       sortingtemplatename        => 'lyeard',
...
fn assertion_003_list_title_order() {
    pass_upstream(
        ...
        r####"$biber->datalists->get_lists_by_attrs(section           => 0,
                                       ...
                                       uniquenametemplatename     => 'global',
                                       labelalphanametemplatename => 'global')->[0]->get_keys"####,
        r####"['K1', 'K7', 'K8', 'K9', 'K4', 'K10', 'K2', 'K11', 'K6', 'K5', 'K12', 'K3']"####,
        r####"is_deeply($biber->datalists->get_lists_by_attrs(section           => 0,
                                       name                       => 'ltitle',
                                       type                       => 'entry',
                                       sortingtemplatename        => 'ltitle',
...
fn assertion_009_list_name_order_swedish() {
    pass_upstream(
        ...
        r####"$biber->datalists->get_lists_by_attrs(section           => 0,
                                       ...
                                       uniquenametemplatename     => 'global',
                                       labelalphanametemplatename => 'global')->[0]->get_keys"####,
        r####"['K11', 'K1', 'K2', 'K4', 'K3', 'K7', 'K8', 'K9', 'K10', 'K12', 'K6', 'K5']"####,
        r####"is_deeply($biber->datalists->get_lists_by_attrs(section           => 0,
                                       name                       => 'lnameswe',
                                       type                       => 'entry',
                                       sortingtemplatename        => 'lnameswe',
...
fn assertion_010_list_title_order_spanish() {
    pass_upstream(
        ...
        r####"$biber->datalists->get_lists_by_attrs(section           => 0,
                                       ...
                                       uniquenametemplatename     => 'global',
                                       labelalphanametemplatename => 'global')->[0]->get_keys"####,
        r####"['K1', 'K4', 'K10', 'K7', 'K8', 'K9', 'K2', 'K11', 'K6', 'K5', 'K12', 'K3']"####,
        r####"is_deeply($biber->datalists->get_lists_by_attrs(section           => 0,
                                       name                       => 'ltitlespan',
                                       type                       => 'entry',
                                       sortingtemplatename        => 'ltitlespan',
...
fn assertion_011_list_granular_locale_spanish() {
    pass_upstream(
        ...
        r####"$biber->datalists->get_lists_by_attrs(section           => 0,
                                       ...
                                       uniquenametemplatename     => 'global',
                                       labelalphanametemplatename => 'global')->[0]->get_keys"####,
        r####"['K1', 'K7', 'K9', 'K8', 'K4', 'K10', 'K2', 'K11', 'K6', 'K5', 'K12', 'K3']"####,
        r####"is_deeply($biber->datalists->get_lists_by_attrs(section           => 0,
                                       name                       => 'ltitleset',
                                       type                       => 'entry',
                                       sortingtemplatename        => 'ltitleset',
...
fn assertion_012_list_sorting_name_key_templates_1() {
    pass_upstream(
        ...
        r####"$biber->datalists->get_lists_by_attrs(section           => 0,
                                       ...
                                       uniquenametemplatename     => 'global',
                                       labelalphanametemplatename => 'global')->[0]->get_keys"####,
        r####"['K11', 'K1', 'K2', 'K4', 'K3', 'K7', 'K5', 'K8', 'K9', 'K10', 'K12', 'K6']"####,
        r####"is_deeply($biber->datalists->get_lists_by_attrs(section           => 0,
                                       name                       => 'lname',
                                       type                       => 'entry',
                                       sortingtemplatename        => 'lname',
...
fn assertion_015_list_dates() {
    pass_upstream(
        ...
        r####"$biber->datalists->get_lists_by_attrs(section           => 1,
                                       ...
                                       uniquenametemplatename     => 'global',
                                       labelalphanametemplatename => 'global')->[0]->get_keys"####,
        r####"['D3', 'D2', 'D1', 'D5', 'D6', 'D7', 'D4']"####,
        r####"is_deeply($biber->datalists->get_lists_by_attrs(section           => 1,
                                       name                       => 'ldates',
                                       type                       => 'entry',
                                       sortingtemplatename        => 'lyear',
                                       sortingnamekeytemplatename => 'global',
