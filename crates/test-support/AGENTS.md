...
- `src/lib.rs`: public fixture assertion/read helpers, checked runtime-checkout asset reads, TeX/reference log normalizers that retain canonical error context, and PL font parsing utilities.
