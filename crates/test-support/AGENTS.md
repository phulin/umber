...
- `tests/pdftex_extension_catalogue.rs`: hermetic retained-pdfTeX fixture property ownership, pinned-source citation, oracle-channel disposition, and exact active-test-link gate.
