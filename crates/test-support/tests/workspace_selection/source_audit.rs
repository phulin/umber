...
const REVIEWED_EXCEPTIONS: &[&str] = &[
    ...
    "crates/tex-exec/src/main_control.rs:850:cfg(any())",
    "crates/tex-exec/src/main_control.rs:960:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1799:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1811:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1821:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1828:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1847:cfg(any())",
    "crates/tex-exec/src/main_control.rs:4597:cfg(any())",
    "crates/tex-exec/src/main_control.rs:9885:cfg(any())",
    "crates/tex-exec/src/main_control.rs:11238:cfg(any())",
    "crates/tex-exec/src/main_control.rs:17304:cfg(any())",
    ...
    "crates/tex-exec/src/main_control.rs:17202:cfg(test) module under a library with `test = false`",
