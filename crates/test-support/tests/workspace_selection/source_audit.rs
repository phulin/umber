...
const REVIEWED_EXCEPTIONS: &[&str] = &[
    ...
    "crates/tex-exec/src/main_control.rs:847:cfg(any())",
    "crates/tex-exec/src/main_control.rs:957:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1796:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1808:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1818:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1825:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1844:cfg(any())",
    "crates/tex-exec/src/main_control.rs:4583:cfg(any())",
    "crates/tex-exec/src/main_control.rs:9871:cfg(any())",
    "crates/tex-exec/src/main_control.rs:11224:cfg(any())",
    "crates/tex-exec/src/main_control.rs:17290:cfg(any())",
    ...
    "crates/tex-exec/src/main_control.rs:17188:cfg(test) module under a library with `test = false`",
