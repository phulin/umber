...
const REVIEWED_EXCEPTIONS: &[&str] = &[
    ...
    "crates/tex-exec/src/main_control.rs:4570:cfg(any())",
    "crates/tex-exec/src/main_control.rs:9858:cfg(any())",
    "crates/tex-exec/src/main_control.rs:11211:cfg(any())",
    "crates/tex-exec/src/main_control.rs:17277:cfg(any())",
    ...
    "crates/tex-exec/src/main_control.rs:17175:cfg(test) module under a library with `test = false`",
