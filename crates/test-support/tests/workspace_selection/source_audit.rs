...
const REVIEWED_EXCEPTIONS: &[&str] = &[
    ...
    "crates/tex-exec/src/main_control.rs:843:cfg(any())",
    "crates/tex-exec/src/main_control.rs:953:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1792:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1804:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1814:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1821:cfg(any())",
    "crates/tex-exec/src/main_control.rs:1840:cfg(any())",
    "crates/tex-exec/src/main_control.rs:4566:cfg(any())",
    "crates/tex-exec/src/main_control.rs:9854:cfg(any())",
    "crates/tex-exec/src/main_control.rs:11207:cfg(any())",
    "crates/tex-exec/src/main_control.rs:17273:cfg(any())",
    ...
    "crates/tex-exec/src/main_control.rs:17171:cfg(test) module under a library with `test = false`",
