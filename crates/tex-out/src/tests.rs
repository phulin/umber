...
const PAGE_OUTPUT_FLOAT_GUARD_SOURCES: &[(&str, &str)] = &[
    ...
    (
        "crates/tex-exec/src/shipout/direct.rs",
        include_str!("../../tex-exec/src/shipout/direct.rs"),
    ),
    (
        "crates/tex-exec/src/box_runtime/hmode.rs",
        include_str!("../../tex-exec/src/box_runtime/hmode.rs"),
    ),
