...
pub(crate) const ABI_FINGERPRINT: u64 = fingerprint(
    b"umber.format.container.v4;le;header=80;directory=40;refs=relative-or-index;sections=deflate;font-info-words=u32;names-hash-occupied=u8;checksum=fnv1a64-zero-field",
);
